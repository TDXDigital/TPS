		...
		function getCallsign(value_name){
			...
			if(value_name==0){
				...
				{// code for IE6, IE5 (Not Supported)
	   			...
	   			xmlhttp.open("GET","/Episode/EPV2/AJAX/getcallsign.php?n="+urlencodephp(value_name),true);
	   			xmlhttp.send();
...
<div id="top">
	...
	<div id="content">
		<form name="search" method="POST" action="/Episode/p2insertEP.php">
	...
	<div id="foot">
		<table>
			<tr>
				...
				<input type="button" value="Reset" disabled="disabled" onClick="window.location.reload()"></td><td>
				<input type="button" value="Classic Page" onClick="window.location.href='/Episode/p1insertEP.php'"></td><td>

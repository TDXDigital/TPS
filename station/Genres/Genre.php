                ...
                <form method="get">
                    ...
                    <div class="left;">
                        ...
                        <input type="submit" value="Remove" disabled/>
                                           ...
                                           echo "<td><input type='text' required placeholder='Unique Name' title='Origional:".$obj->genreid."' value='".$obj->genreid."'/></td>";
                                           echo "<td><input type='number' required placeholder='CC/Hr' title='Origional:".$obj->cancon."' value='".$obj->cancon."'/></td>";
                                           echo "<td>".$obj->playlist."</td>";
                                           echo "<td>";
                                           echo floatval($obj->canconperc)*100;
                                           echo "%</td>";

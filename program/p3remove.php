...
echo "<tr height=\"20\"><td colspan=\"100%\" style=\"text-align:bottom;\"><hr/></td></tr><tr><td>
        <form name=\"logout\" action=\"../logout.php\" method=\"POST\">
              <input type=\"submit\" value=\"Logout\">
        </form>
        </td><td><form name=\"return\" action=\"../masterpage.php\" method=\"POST\">
     <input type=\"submit\" value=\"Return\"></form></td><td>
     <form name=\"remove\" action=\"p1remove.php\" method=\"POST\">
     <input type=\"submit\" value=\"Search\"></form>
     <td colspan=\"4\" height=\"10\" style=\"text-align:right\">
        <img src=\"../images/mysqls.png\" alt=\"MySQL\"></td></tr></table>";

...
<body>
	...
	<tr><td colspan="4" width="1000">
        ...
        <tr height="50" valign="middle">
	            ...
	            <button onclick="window.location.href='../legacy/oep/EPV2/p1insert.php'" value="New Program Log">New Program Log</button>
	            ...
	            <button onclick="window.location.href='../legacy/oep/p1view.php'" value="View Program Log">View Program Log</button>
	     </td><td width="450">
	            <!--<a href="oep/p1update.php">Edit Program Log</a>-->
	            <button onclick="window.location.href='../legacy/oep/p1update.php'" value="Update Program Log">Update Program Log</button>
	     </td><td width="450">
	            <!--<a href="oep/p1advremove.php">Remove Program Log</a>-->
	            <button onclick='window.location.href="../legacy/oep/p1advremove.php"' value="Delete Program Log">Remove Program Log</button>
	...
	<tr><td colspan="4">
        <hr /><h2>Programs</h2>
              ...
              <tr height="50" valign="middle">
              	<td><button onclick='window.location.href="../legacy/program/p1insert.php"' value="New Program"> New Program </button></td>
	            <td><button onclick='window.location.href="../legacy/program/p1view.php"' value="View Program"> View Program </button></td>
	            <td><button onclick='window.location.href="../legacy/program/p1advupdate.php"' value="Edit Program"> Edit Program </button></td>
	            <td><button onclick='window.location.href="../legacy/program/p1remove.php"' value="Remove Program"> Remove Program </button></td>
             </tr>
             <tr height="50" valign="middle">
    ...
    <tr><td colspan="4">
        <hr /><h2>Commercials</h2>
              ...
              <tr height="50" valign="middle">
              	<td><button onclick='window.location.href="../legacy/Advertisements/p1advins.php"' value="New Commercial"> New Commercial </button></td>
	            <td><button onclick='window.location.href="../legacy/Advertisements/p1update.php"' value="View Commercials"> View Commercial </button></td>
	            <td><button onclick='window.location.href="../legacy/Advertisements/p1update.php"' value="Edit Commercial"> Edit Commecrial</button></td>
	            <td><button disabled="true" onclick='window.location.href="../legacy/program/p1update.php"' value="Remove Commercial"> Remove Commercial </button></td>
             </tr>
              <tr><td colspan="4">

...
<body>
	...
	<tr><td colspan="4" style="width: 1000px">
        ...
        <tr style="height:50px; vertical-align: middle">
	            ...
	            <button onclick="window.location.href='../legacy/oep/EPV2/p1insert.php'" <?php
	            	if($ACCold != TRUE){
	            		 echo " disabled ";
	            	}
	            ?>value="New Program Log">New Program Log</button>
	     </td><td style="width: 450px">
	            <button onclick="window.location.href='../legacy/oep/p1update.php'"<?php
	            	if($ACCold != TRUE){
	            		 echo " disabled ";
	            	}
     ...
     <h3>(Version 0.3)</h3><span style="font-size: 9px"><i>works with: IE, Safari, Firefox, Chrome</i></span>
        ...
        <tr style="height: 50px; vertical-align: middle;">
	            ...
	            <button onclick="window.location.href='/legacy/oep/EPV3/logs.php?ref=1'" <?php
	            	if($ACCnew != TRUE){
	            		 echo " disabled ";
	            	}
	...
	<tr><td colspan="4">
        <hr /><h2>Program Maintenance</h2>
              ...
              <tr style="height: 50px; vertical-align: middle">
	            <td><button onclick='window.location.href="../legacy/program/p1view.php"' value="View Program" disabled>Update Program</button></td>
             </tr>
        <!--<tr><td colspan="4">
        <hr />  <h2>Reports</h2>
        </td></tr>

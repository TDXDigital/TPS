...
<html lang="en">
    <head>
        ...
        <title>TPS Broadcast - Playlist Update</title>
        ...
        <script src="<?php echo $_SESSION['BASE_REF'];?>/JS/GLOBAL/Utilities.js"></script>
    ...
    <div class="container" style="margin-top: 30px">
        <div class="page-header">Playlist Update</div>
            <div class="ui-state-highlight">
                <div id="input" class="panel panel-success">
                    ...
                    <div class="panel-body"><form action="upload_playlist.php" method="post" onsubmit="submitted();"
                            ...
                            <fieldset title="XLS / XLSX Playlist Update">
                                <p>This requires your playlist XLS file in the supported (supplied) format. This is likely the same file as your playlist update file</p>
                                <label for="file">Filename:</label>
                                <input type="file" name="file" id="file" required><br>
                                <label for="library">Library Already Updated</label>
                                <input type="checkbox" id="library" checked required/><span>**This needs to be checked currently... please check it</span><br>

      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li <?php if($PAGE=="wel"){echo "class='active' ";}?>><a href="?q=wel">Welcome</a></li>
            <li <?php if($PAGE=="db"){echo "class='active' ";}?>><a href="?q=db">Database</a></li>
            <li <?php if($PAGE=="auth"){echo "class='active' ";}?>><a href="?q=auth">Authentication</a></li>
            <li <?php if($PAGE=="settings"){echo "class='active' ";}?>><a href="?q=settings">Settings</a></li>
            <li <?php if($PAGE=="review"){echo "class='active' ";}?>><a href="?q=review">Review</a></li>
            <li <?php if($PAGE=="done"){echo "class='active' ";}?>><a href="?q=done">Complete</a></li>

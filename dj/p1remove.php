...
<body>
      ...
      <td>
<?php
if(strtoupper($_SESSION['usr'])=="USER"){
...
if (!$con){
	...
	die('Error connecting to SQL Server, could not connect due to: ' . mysql_error() . ';  username=' . $_SESSION["usr"]);
        ...
        years
             ...
             <tr>
             <td colspan="2">
                 <input name="Alias" type="text" size="40%" value="%" autofocus/>
             </td>
             <td>
        ...
        <tr>
        <form name="Direct" action="p3remove.php" method="post">
              <td colspan="2">Direct Removal</td>
              <td>
                 <select name="Alias">
                         <?php echo $djoptions;?>
                 </select>
